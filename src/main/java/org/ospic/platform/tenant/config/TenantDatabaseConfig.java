...
@ComponentScan(basePackages = {
        "org.ospic.platform.tenant.app.*.repository", "org.ospic.platform.tenant.app.*.domain",
        "org.ospic.platform.tenant.app.*.*.repository", "org.ospic.platform.tenant.app.*.*.domain"})
@EnableJpaRepositories(basePackages = {
        "org.ospic.platform.tenant.app.*.repository", "org.ospic.platform.tenant.app.*.service",
        "org.ospic.platform.tenant.app.*.*.repository", "org.ospic.platform.tenant.app.*.*.service"},
...
public class TenantDatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        emfBean.setPackagesToScan("org.ospic.platform");
