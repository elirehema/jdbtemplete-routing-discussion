...
public final class DataSourceUtil {
    ...
    public static DataSource createAndConfigureDataSource(MasterTenant masterTenant) {
        ...
        String tenantConnectionPoolName = masterTenant.getTenantName() + "-connection-pool";
        ds.setPoolName(tenantConnectionPoolName);
        LOG.info("Configured datasource:" + masterTenant.getTenantName() + ". Connection pool name:" + tenantConnectionPoolName);
        return ds;
    }
}
